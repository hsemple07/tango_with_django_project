...
def populate():
    python_pages = [{'title': 'Official Python Tutorial', 'url': 'http://docs.python.org/3/tutorial/', 'views': 128},
    ...
    django_pages = [{'title': 'Official Django Tutorial', 'url': 'https://docs.djangoproject.com/en/2.1/intro/tutorial01/', 'views': 128}, 
    ...
    other_pages = [{'title': 'Bottle', 'url': 'http://bottlepy.org/docs/dev/', 'views': 128},
